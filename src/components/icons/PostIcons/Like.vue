<template>
<span class="hoverDuration hover:text-[#f9189e] cursor-pointer group">
	    <div class="w-[46px] inline-flex items-center justify-between">
	     <span class="w-8.5 h-8.5 flexCenter rounded-full bg-white hoverDuration group-hover:bg-[#f9189e66]">
	    <svg width="20" height="20" viewBox="0 0 20 20" class=" fill-[#5B7083] group-hover:fill-[#f9189e]">
