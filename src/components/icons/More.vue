<template>
	<span class="absolute  w-8.3 h-8.3 bg-transparent hover:rounded-full hover:bg-[#1d9bf01a] right-[-7px] flexCenter group">
        <svg  viewBox="0 0 24 24"  class="w-[17.5px] h-[17.5px] group-hover:fill-[#1d9bf0] fill-[#536471]">
...
<!--w-8.3 h-8.3 rounded-full bg-red-100-->