<template>
	<div class="w-full h-[114px] py-1 px-[15px] inline-flex flex-row justify-between border-b border-min-border-color">
	<div class="w-[57px] pr-[11px]">
		<div class="w-[46px] h-[46px] bg-black rounded-full"></div>
	</div>
	<div class="w-full flex flex-col">
		<div class="w-full min-h-[27px] py-[11px] bg-black">
